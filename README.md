...
![랜딩](docs/demo/1-랜딩.gif)

> 원본 영상: [1-랜딩.webm](docs/demo/1-랜딩.webm)

### 2. 커리어 저장소 : 이력서·포트폴리오를 근거 단위로 분해

![커리어 조각](docs/demo/2-커리어조각.gif)

> 원본 영상: [2-커리어조각.webm](docs/demo/2-커리어조각.webm)
...
![커리어 분석](docs/demo/3-커리어분석.gif)

> 원본 영상: [3-커리어분석.webm](docs/demo/3-커리어분석.webm)
...
![대화](docs/demo/4-대화.gif)

> 원본 영상: [4-대화.webm](docs/demo/4-대화.webm)
...
![학습 플랜](docs/demo/5-학습플랜.gif)

> 원본 영상: [5-학습플랜.webm](docs/demo/5-학습플랜.webm)
